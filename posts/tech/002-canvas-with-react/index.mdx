...
Tip: Make sure to debounce the `resizeCanvas` method by either using lodash/underscore's [debounce](https://underscorejs.org/) or implementing your [own!](https://dev.to/gabe_ragland/debouncing-with-react-hooks-jci)
